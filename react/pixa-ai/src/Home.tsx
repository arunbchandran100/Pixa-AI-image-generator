...
const PhotoOption: React.FC<PhotoOptionProps> = ({ photo }) => {
  ...
  return (
    <div className="photo-option" onClick={handleClick}> {/* Add onClick handler to the container */}
...
function Home() {
  ...
  return (
    <div>
      ...
      {/* Description */}
      <div className="description">Choose the styles from below to edit your photos</div>
